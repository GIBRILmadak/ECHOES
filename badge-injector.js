...
(function() {
  ...
  // Mapping démonstratif (à enrichir via registerUserBadge)
  const BADGE_MAP = new Map([
    ['Jean Dupont', 'badges/star.svg'],
    ['Sophie Martin', 'badges/new.svg'],
    ['Alexandre', 'badges/first.svg'],
    ['Emma', 'badges/step.svg'],
    ['Groupe Voyage', 'badges/explorateur.svg'],
    ['TravelAdventures', 'badges/explorateur.svg'],
    ['ChefMichel', 'badges/or.svg'],
    ['TechEnthusiast', 'badges/vision.svg'],
    ['TravelLover', 'badges/collector.svg'],
    ['ZenMaster', 'badges/calme.svg'],
    ['BookWorm', 'badges/rare.svg'],
    ['RemoteWorker', 'badges/step.svg'],
    ['Alex Rivers', 'badges/star.svg'],
    ['Luna Martinez', 'badges/platine.svg'],
    ['The Midnight Collective', 'badges/diamant.svg'],
    ['Jazz Fusion Band', 'badges/or.svg'],
    ['Sarah Chen', 'badges/or.svg'],
    ['DJ Phoenix', 'badges/vision.svg'],
    ['Marcus Blue', 'badges/platine.svg']
  ]);
  ...
  document.addEventListener('DOMContentLoaded', () => {
    try { runInjection(); } catch (e) { /* silencieux */ }
